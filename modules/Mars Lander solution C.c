// credits: https://github.com/denvash/codingame-puzzles-solutions/blob/master/2-Medium/Mars-Lander-Episode-2.cpp
...
struct point grnd[100], landl, landr;
